...
export const instructions: Record<string, arguments> = {
    ...
    'b.ge': (arg1)           => `Jump to ${arg1} if >=`,
    'b.le': (arg1)           => `Jump to ${arg1} if <=`,
    'b.eq': (arg1)           => `Jump to ${arg1} if ==`,
    'b.ne': (arg1)           => `Jump to ${arg1} if !=`,
    'b.lt': (arg1)           => `Jump to ${arg1} if <`,
    'b.gt': (arg1)           => `Jump to ${arg1} if >`,
